...
@Deprecated public class AssemblerRecipes extends SerializableRecipe {
	...
	public void registerDefaults() {
		...
		makeRecipe(new ComparableStack(ModItems.mp_thruster_30_balefire_large, 1), new AStack[] {new ComparableStack(ModItems.seg_10, 1), new ComparableStack(ModItems.seg_20, 1), new ComparableStack(ModItems.mp_thruster_15_balefire_large, 1), new ComparableStack(ModBlocks.pwr_fuel, 12), new OreDictStack("wallDenseTantalumHafniumCarbide", 12), new OreDictStack(BIGMT.block(), 8), new OreDictStack(W.plateCast(), 30), new ComparableStack(ModItems.ingot_u233, 52), new ComparableStack(ModItems.pipes_steel, 18), },5000);
