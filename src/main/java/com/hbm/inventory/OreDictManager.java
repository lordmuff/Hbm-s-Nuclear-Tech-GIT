...
public class OreDictManager {
	...
	public static void registerOres() {
		...
		IRON.plate(plate_iron).dust(powder_iron).ore(ore_gneiss_iron, DictFrame.fromOne(ore_meteor, BlockEnums.EnumMeteorType.IRON)).oreAll(ore_iron);
		...
		CM243	.rad(HazardRegistry.cm243)							.nugget(nugget_cm243)		.billet(billet_cm243)		.ingot(ingot_cm243);
		CM244	.rad(HazardRegistry.cm244)							.nugget(nugget_cm244)		.billet(billet_cm244)		.ingot(ingot_cm244);
		CM245	.rad(HazardRegistry.cm245)						.nugget(nugget_cm245)		.billet(billet_cm245)		.ingot(ingot_cm245);
		...
		CMRG    .rad(HazardRegistry.cmrg)                            .nugget(nugget_cm_mix)         .billet(billet_cm_mix)		.ingot(ingot_cm_mix);
		CMF    .rad(HazardRegistry.cmf)			                    .nugget(nugget_cm_fuel)         .billet(billet_cm_fuel)		.ingot(ingot_cm_fuel);
		...
		CF252	.rad(HazardRegistry.cf252)							.nugget(nugget_cf252)								.billet(billet_cf252)		.ingot(ingot_cf252);
		ES253	.rad(HazardRegistry.es253)                          .nugget(nugget_es253)	   	.billet(billet_es253)       .ingot(ingot_es253);
		...
		REIIUM		.nugget(nugget_reiium)									.ingot(ingot_reiium)		.dust(powder_reiium)		.block(block_reiium)		.oreAll(ore_reiium);
		WEIDANIUM	.nugget(nugget_weidanium)								.ingot(ingot_weidanium)		.dust(powder_weidanium)		.block(block_weidanium)		.oreAll(ore_weidanium);
		UNOBTAINIUM	.nugget(nugget_unobtainium)								.ingot(ingot_unobtainium)	.dust(powder_unobtainium)	.block(block_unobtainium)	.oreAll(ore_unobtainium);
		VERTICIUM	.nugget(nugget_verticium)								.ingot(ingot_verticium)		.dust(powder_verticium)		.block(block_verticium)		.oreAll(ore_verticium);
		DAFFERGON	.nugget(nugget_daffergon)								.ingot(ingot_daffergon)		.dust(powder_daffergon)		.block(block_daffergon)		.oreAll(ore_daffergon);
