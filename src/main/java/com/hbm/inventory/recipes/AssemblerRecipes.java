...
@Deprecated public class AssemblerRecipes extends SerializableRecipe {
	...
	public void registerDefaults() {
		...
		makeRecipe(new ComparableStack(ModItems.rod_zirnox, 1, ItemZirnoxRod.EnumZirnoxType.GRAVEL.ordinal()), new AStack[] {new ComparableStack(Blocks.gravel, 1024), new ComparableStack(ModItems.rod_zirnox_empty, 1) }, 450);
