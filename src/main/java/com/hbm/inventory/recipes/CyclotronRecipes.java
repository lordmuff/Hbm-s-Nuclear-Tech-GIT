...
public class CyclotronRecipes extends SerializableRecipe {
	...
	public void registerDefaults() {
		...
		makeRecipe(new ComparableStack(ModItems.part_lithium), new OreDictStack("dustStrontium"), new ItemStack(ModItems.powder_zirconium), liA);
		...
		makeRecipe(new ComparableStack(ModItems.part_beryllium), new OreDictStack("dustStrontium"), new ItemStack(ModItems.powder_niobium), beA);
		makeRecipe(new ComparableStack(ModItems.part_beryllium), new OreDictStack("dustCerium"), new ItemStack(ModItems.powder_neodymium), beA);
		...
		makeRecipe(new ComparableStack(ModItems.part_carbon), new OreDictStack("dustCaesium"), new ItemStack(ModItems.powder_lanthanium), caA);
		makeRecipe(new ComparableStack(ModItems.part_carbon), new OreDictStack("dustNeodymium"), new ItemStack(ModItems.powder_gold), caA);
		...
		makeRecipe(new ComparableStack(ModItems.part_copper), new OreDictStack("dustBromine"), new ItemStack(ModItems.powder_iodine), coA);
		makeRecipe(new ComparableStack(ModItems.part_copper), new OreDictStack("dustStrontium"), new ItemStack(ModItems.powder_neodymium), coA);
		makeRecipe(new ComparableStack(ModItems.part_copper), new OreDictStack("dustNiobium"), new ItemStack(ModItems.powder_caesium), coA);
		makeRecipe(new ComparableStack(ModItems.part_copper), new OreDictStack("dustIodine"), new ItemStack(ModItems.powder_polonium), coA);
		makeRecipe(new ComparableStack(ModItems.part_copper), new OreDictStack("dustCaesium"), new ItemStack(ModItems.powder_actinium), coA);
