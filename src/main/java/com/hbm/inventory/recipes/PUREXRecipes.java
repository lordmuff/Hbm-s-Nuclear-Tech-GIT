...
public class PUREXRecipes extends GenericRecipes<GenericRecipe> {
	...
	public void registerDefaults() {
		...
		this.register(new GenericRecipe("purex.pwrmep").setup(100, pwrPower).setNameWrapper("purex.recycle").setGroup(autoPWR, this)
			...
			.inputFluids(new FluidStack(Fluids.KEROSENE, 500), new FluidStack(Fluids.NITRIC_ACID, 250))
			.outputItems(new ItemStack(ModItems.nugget_pu241, 2),
		...
		this.register(new GenericRecipe("purex.bffrfuel").setNameWrapper("purex.recycle").setup(120, 3_750)
			...
			.setIconToFirstIngredient());
		this.register(new GenericRecipe("purex.bffrfuel.gt6").setNameWrapper("purex.recycle").setup(120, 3_750)
		...
		this.register(new GenericRecipe("purex.zirnoxpu241").setNameWrapper("purex.recycle").setup(220, 13_133)
			.inputItems(new ComparableStack(ModItems.waste_pu241, 1))
			.inputFluids(new FluidStack(Fluids.KEROSENE, 500), new FluidStack(Fluids.NITRIC_ACID, 250))
			.outputItems(new ItemStack(ModItems.nugget_am242, 3),
				new ItemStack(ModItems.nugget_am241, 2),
				new ItemStack(ModItems.nugget_pu241, 1),
				new ItemStack(ModItems.nuclear_waste_tiny, 1)));

		this.register(new GenericRecipe("purex.zirnoxamrg").setNameWrapper("purex.recycle").setup(220, 13_133)
			.inputItems(new ComparableStack(ModItems.waste_amrg, 1))
			.inputFluids(new FluidStack(Fluids.KEROSENE, 500), new FluidStack(Fluids.NITRIC_ACID, 250))
			.outputItems(new ItemStack(ModItems.nugget_cm_mix, 3),
		...
		this.register(new GenericRecipe("purex.zirnoxamf").setNameWrapper("purex.recycle").setup(220, 13_133)
			.inputItems(new ComparableStack(ModItems.waste_amf, 1))
			.inputFluids(new FluidStack(Fluids.KEROSENE, 500), new FluidStack(Fluids.NITRIC_ACID, 250))
			.outputItems(new ItemStack(ModItems.nugget_cm_mix, 3),
				new ItemStack(ModItems.nugget_bk247, 1),
		...
		this.register(new GenericRecipe("purex.zirnoxcmrg").setNameWrapper("purex.recycle").setup(220, 13_133)
			.inputItems(new ComparableStack(ModItems.waste_cmrg, 1))
			.inputFluids(new FluidStack(Fluids.KEROSENE, 500), new FluidStack(Fluids.NITRIC_ACID, 250))
			.outputItems(new ItemStack(ModItems.nugget_cm_mix, 1),
				new ItemStack(ModItems.nugget_cf252, 2),
				new ItemStack(ModItems.nugget_cf251, 2),
				new ItemStack(ModItems.nuclear_waste_tiny, 1)));

		this.register(new GenericRecipe("purex.zirnoxcmf").setNameWrapper("purex.recycle").setup(220, 13_133)
			.inputItems(new ComparableStack(ModItems.waste_cmf, 1))
			.inputFluids(new FluidStack(Fluids.KEROSENE, 500), new FluidStack(Fluids.NITRIC_ACID, 250))
			.outputItems(new ItemStack(ModItems.nugget_cm_mix, 1),
		...
		this.register(new GenericRecipe("purex.zirnoxcf251").setNameWrapper("purex.recycle").setup(220, 13_133)
			.inputItems(new ComparableStack(ModItems.waste_cf251, 1))
			.inputFluids(new FluidStack(Fluids.KEROSENE, 500), new FluidStack(Fluids.NITRIC_ACID, 250))
			.outputItems(new ItemStack(ModItems.nugget_cm247, 1),
				new ItemStack(ModItems.nugget_cm_mix, 3),
				new ItemStack(ModItems.nugget_cf251, 1),
				new ItemStack(ModItems.nuclear_waste_tiny, 1)));

		this.register(new GenericRecipe("purex.zirnoxcf252").setNameWrapper("purex.recycle").setup(220, 13_133)
			.inputItems(new ComparableStack(ModItems.waste_cf252, 1))
			.inputFluids(new FluidStack(Fluids.KEROSENE, 500), new FluidStack(Fluids.NITRIC_ACID, 250))
			.outputItems(new ItemStack(ModItems.nugget_cm244, 1),
				new ItemStack(ModItems.nugget_cm_mix, 3),
				new ItemStack(ModItems.nugget_cf252, 1),
				new ItemStack(ModItems.nuclear_waste_tiny, 1)));

		this.register(new GenericRecipe("purex.zirnoxbk247").setNameWrapper("purex.recycle").setup(220, 13_133)
			.inputItems(new ComparableStack(ModItems.waste_bk247, 1))
			.inputFluids(new FluidStack(Fluids.KEROSENE, 500), new FluidStack(Fluids.NITRIC_ACID, 250))
			.outputItems(new ItemStack(ModItems.nugget_pu239, 1),
				new ItemStack(ModItems.nugget_am_mix, 2),
				new ItemStack(ModItems.nugget_u235, 1),
				new ItemStack(ModItems.nuclear_waste_tiny, 1)));

		this.register(new GenericRecipe("purex.zirnoxes253").setNameWrapper("purex.recycle").setup(220, 13_133)
			.inputItems(new ComparableStack(ModItems.waste_es253, 1))
			.inputFluids(new FluidStack(Fluids.KEROSENE, 500), new FluidStack(Fluids.NITRIC_ACID, 250))
			.outputItems(new ItemStack(ModItems.nugget_am_mix, 2),
				new ItemStack(ModItems.nugget_cm_mix, 2),
				new ItemStack(ModItems.nugget_bk247, 1),
				new ItemStack(ModItems.nuclear_waste_tiny, 1)));

		this.register(new GenericRecipe("purex.zirnoxleaus").setNameWrapper("purex.recycle").setup(220, 13_133)
			.inputItems(new ComparableStack(ModItems.waste_leaus, 1))
			.inputFluids(new FluidStack(Fluids.KEROSENE, 500), new FluidStack(Fluids.NITRIC_ACID, 250))
			.outputItems(new ItemStack(Items.gold_nugget, 3),
				new ItemStack(ModItems.nugget_australium, 2),
				new ItemStack(ModItems.nugget_australium_lesser, 5),
				new ItemStack(ModItems.nuclear_waste_tiny, 1)));

		this.register(new GenericRecipe("purex.zirnoxmeaus").setNameWrapper("purex.recycle").setup(220, 13_133)
			.inputItems(new ComparableStack(ModItems.waste_meaus, 1))
			.inputFluids(new FluidStack(Fluids.KEROSENE, 500), new FluidStack(Fluids.NITRIC_ACID, 250))
			.outputItems(new ItemStack(Items.gold_nugget, 3),
				new ItemStack(ModItems.nugget_australium_lesser, 5),
		...
		this.register(new GenericRecipe("purex.zirnoxheaus").setNameWrapper("purex.recycle").setup(220, 13_133)
			.inputItems(new ComparableStack(ModItems.waste_heaus, 1))
			.inputFluids(new FluidStack(Fluids.KEROSENE, 500), new FluidStack(Fluids.NITRIC_ACID, 250))
			.outputItems(new ItemStack(ModItems.nugget_australium_lesser, 3),
				new ItemStack(ModItems.nugget_australium, 2),
				new ItemStack(ModItems.nugget_australium_greater, 4),
				new ItemStack(ModItems.nuclear_waste_tiny, 1)));

		this.register(new GenericRecipe("purex.zirnoxgravel").setNameWrapper("purex.recycle").setup(220, 13_133)
			.inputItems(new ComparableStack(ModItems.waste_gravel, 2))
			.inputFluids(new FluidStack(Fluids.KEROSENE, 500), new FluidStack(Fluids.NITRIC_ACID, 250))
			.outputItems(new ItemStack(ModItems.nugget_australium_lesser, 6),
		...
		this.register(new GenericRecipe("purex.gravelsloodge").setNameWrapper("purex.gravelsloodge").setup(444, 20_000).setIcon(ModBlocks.block_australium)
			.inputFluids(new FluidStack(Fluids.RADIOSOLVENT, 12_000), new FluidStack(Fluids.LEAD_HOT, 3_000), new FluidStack(Fluids.GASEOUS_URANIUM_BROMIDE, 500))
			.inputItems(new ComparableStack(Blocks.gravel, 64), new ComparableStack(Blocks.gravel, 64), new ComparableStack(Blocks.gravel, 64))
			.outputFluids(new FluidStack(Fluids.GRAVELSLOODGE, 1_750)));
